...
- Name: tourGuides.spec.js >> Tour Guides public listing >> CTA to register is visible
- Location: tests\e2e\tourGuides.spec.js:14:3
...
Locator: getByRole('link', { name: /register|become a guide/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /register|become a guide/i })
