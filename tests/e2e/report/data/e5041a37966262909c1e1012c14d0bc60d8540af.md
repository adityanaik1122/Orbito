...
- Name: tourGuides.spec.js >> Tour Guide registration form >> submitting empty form shows validation
- Location: tests\e2e\tourGuides.spec.js:33:3
...
Call log:
  - waiting for getByRole('button', { name: /register|submit|create/i })
