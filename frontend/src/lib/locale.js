...
const MESSAGES = {
  'en': {
    ...
    planner_hint: 'Need inspiration? Ask me to "Add a romantic dinner on Day 2" or "Optimize my route".',
    planner_prompt_placeholder: 'Tell AI what to help you with...',
    planner_generate_button: 'Ask AI',
  ...
  'fr': {
    ...
    planner_hint: 'Besoin d’inspiration ? Demandez « Ajouter un dîner romantique le Jour 2 » ou « Optimiser mon itinéraire ».',
    planner_prompt_placeholder: 'Dites à l’IA comment vous aider...',
    planner_generate_button: 'Demander à l’IA',
